...
// Error Calculation 
ISE = 0
ISE2 = 0 // Integral square error
IAE = 0
IAE2 = 0  // Integral absolute error
ITSE = 0
ITSE2 = 0 // Integral Time squared error
ITAE = 0 
ITAE2 = 0 // Integral time absolue error
for i = 1:L
      E(i) = Omega_est(i) - Omega(i)
      E1(i) = Omega_est2(i) - Omega(i)
      ISE = ISE + (E(i)^2) 
       ISE2 = ISE2 + (E1(i)^2) 
       IAE = IAE + abs(E(i))
       IAE2 = IAE2 + abs(E1(i))
       ITSE = ITSE + i*0.001*(E(i)^2)
       ITSE2 = ITSE2 + i*0.001*(E1(i)^2)
       ITAE = ITAE + i*0.001*abs(E1(i))
       ITAE2 = ITAE2 + i*0.001*abs(E1(i)^2)
end      
    print(%io(2),ISE)
    print(%io(2),ISE2)
     print(%io(2),IAE)
